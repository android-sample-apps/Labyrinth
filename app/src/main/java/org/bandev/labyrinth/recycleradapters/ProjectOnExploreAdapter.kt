...
/**
 * Show a list of [Explore.ProjectOnExplore] classes to the user.
...
class ProjectOnExploreAdapter(
    private val projectList: MutableList<Explore.ProjectOnExplore>,
    private val imageLoader: ImageLoader,
    private val clickListener: ClickListener,
    private val context: Context
) : RecyclerView.Adapter<ProjectOnExploreAdapter.ViewHolder>() {
    ...
    interface ClickListener {
        fun onClick(project: Explore.ProjectOnExplore)
    }
}